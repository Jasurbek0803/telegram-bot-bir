...
async def confirm_add_admin(message: Message, state: FSMContext):
    try:
    ...
    if db.is_admin(admin_id):
        ...
        add_admin_to_db(admin_id, message.from_user.full_name)
        await message.answer(f"✅ Foydalanuvchi {admin_id} admin sifatida qo‘shildi.")
